...
{ 3, "Dot", 1, "Skill Damage over Time", colorCodes.OFFENCE, {
    ...
    { label = "Damage over Time", notFlag = "dot_scales_with_instances",
    ...
    { label = "DoT per Instance", flag = "dot_scales_with_instances",
      { format = "{1:output:TotalDot}", },
      { format = "{1:output:PhysicalDot}", { breakdown = "PhysicalDot" }, },
      { format = "{1:output:LightningDot}", { breakdown = "LightningDot" }, },
      { format = "{1:output:ColdDot}", { breakdown = "ColdDot" }, },
    ...
    { label = "Total DoT", flag = "dot_scales_with_instances",
      { format = "{1:output:TotalInstanceScaledDot}", },
      { format = "{1:output:PhysicalInstanceScaledDot}", { breakdown = "PhysicalInstanceScaledDot" }, },
      { format = "{1:output:LightningInstanceScaledDot}", { breakdown = "LightningInstanceScaledDot" }, },
      { format = "{1:output:ColdInstanceScaledDot}", { breakdown = "ColdInstanceScaledDot" }, },
      { format = "{1:output:FireInstanceScaledDot}", { breakdown = "FireInstanceScaledDot" }, },
      { format = "{1:output:ChaosInstanceScaledDot}", { breakdown = "ChaosInstanceScaledDot" }, },
    },
	{ label = "Mana Cost", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { modName = "ManaCost", cfg = "skill" }, }, },
} },
...
{ 1, "EleAilments", 1, "Elemental Ailments", colorCodes.OFFENCE, {
	...
	{ label = "Chill Dur. Mod:", flag = "chill", { format = "x {2:output:ChillDurationMod}",
		...
		{ breakdown = "ChillDPS" },
		{ label = "Player modifiers", modName = "EnemyChillDuration", cfg = "skill" },
		{ label = "Enemy modifiers", modName = "SelfChillEffect", enemy = true },
	}, },
